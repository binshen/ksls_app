...
class Agendawx_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('agenda_wx_model');
        ...
        if ( strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger') !== false ) {
            if(!$this->session->userdata('agewx_openid')){
    ...
    public function buildWxData(){
        ...
        $signPackage = $this->wxgetSignPackage_age();
        //变量
    ...
    public function wxgetSignPackage_age() {
        $jsapiTicket = $this->agenda_wx_model->get_ticket($this->wxconfig['appid'],$this->wxconfig['appsecret']);
