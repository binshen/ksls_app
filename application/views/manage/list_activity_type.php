...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="<?php echo site_url('manage/add_activity_type')?>" target="dialog" rel="add_role" title="新建"><span>新建</span></a></li>
            ...
            <li><a class="edit" href="<?php echo site_url('manage/edit_activity_type/{id}')?>" target="dialog" rel="edit_role" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
        </ul>
    </div>
